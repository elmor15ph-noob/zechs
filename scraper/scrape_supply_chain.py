...
if __name__ == "__main__":
    ...
    asyncio.run(scraper.crawl("https://help.sap.com/docs/SAP_S4HANA_CLOUD_PRIVATE_EDITION?task=supply_chain", max_pages=10))
    asyncio.run(scraper.crawl("https://help.sap.com/docs/SAP_S4HANA_ON-PREMISE?task=supply_chain", max_pages=10))
